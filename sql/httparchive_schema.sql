...
CREATE TABLE `requests` (
  ...
  KEY `pageid` (`pageid`)
) ENGINE=MyISAM AUTO_INCREMENT=1352475799 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `pages` (
  ...
  KEY `urlhash` (`urlhash`)
) ENGINE=MyISAM AUTO_INCREMENT=16082170 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `requestsmobile` (
  ...
  UNIQUE KEY `startedDateTime` (`startedDateTime`,`pageid`,`urlShort`),
  KEY `pageid` (`pageid`)
) ENGINE=MyISAM AUTO_INCREMENT=15631148 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `pagesmobile` (
  ...
  PRIMARY KEY (`pageid`),
  UNIQUE KEY `label` (`label`,`urlShort`)
) ENGINE=MyISAM AUTO_INCREMENT=280527 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2014-05-05  9:18:47
